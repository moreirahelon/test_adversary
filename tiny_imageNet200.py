'''Train TINY IMAGENET-200 with PyTorch.'''
...
parser = argparse.ArgumentParser(description='PyTorch TINY IMAGENET-200 Training')
...
if args.beta > 0:
    net = PreActResNet18Parseval(classes=200)
else:
    net = PreActResNet18(classes=200)
if use_cuda:
    net.cuda()
